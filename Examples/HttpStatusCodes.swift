...
/**
 Docs from http://www.restapitutorial.com/httpstatuscodes.html#
 **/
public enum HttpStatusCode : Int {
    ...
    public var isInformational:Bool { return category == .informational }
    
    public var isSuccess:Bool { return category == .success }
    
    public var isRedirection:Bool { return category == .redirection }
    
    public var isClientError:Bool { return category == .clientError }
    
    public var isServerError:Bool { return category == .serverError }
