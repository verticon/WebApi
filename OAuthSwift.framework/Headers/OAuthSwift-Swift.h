...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OAuthSwift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface OAuthSwiftCredential : NSObject <NSSecureCoding>
...
typedef SWIFT_ENUM(NSInteger, ParamsLocation, closed) {
...
SWIFT_CLASS("_TtC10OAuthSwift16SafariURLHandler") SWIFT_AVAILABILITY(ios,introduced=9.0)
